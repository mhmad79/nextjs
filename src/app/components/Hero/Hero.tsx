...
export const Hero: React.FC<HeroProps> = ({title}) => {
  ...
  <div className="relative isolate px-6 pt-40 lg:px-8">
    ...
    <div className="mx-auto max-w-2xl py-11 sm:py-48 lg:py-10">
      <div className="hidden sm:mb-8 sm:flex sm:justify-center">
       
      </div>
      <div className="text-center">
        <h1 className="text-balance text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">{title} Page</h1>
